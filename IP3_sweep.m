...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
chain = 'rx';   %Signal chain e.g., Tx or Rx
...
switch lower(chain)
    case 'tx'
        model = 'C:\Users\Jiwoo Kim (C)\Documents\workaround\RF System Design\simulink\RF_system\Tx_System';
        load_system(model);
        ...
        save('Tx_Power_Error_10dBm.mat', 'Error', 'min_err');
        
        plot(IP3, min_err, '-o', LineWidth=2)
        grid on;
        
        title('IP3 vs. Error Power')
        xlabel('OIP3 (dBm)');
    ...
    case 'rx'
        ...
        save('Rx_Power_Error_10dBm.mat', 'Error', 'min_err');
